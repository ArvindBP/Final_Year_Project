...
void loop() {
 ...
 char frame1[10];
 sprintf(frame1,"%.10s",buffer6);

 sprintf(frame, "visor=false&latitude=%.16s&longitude=%.16s&altitude=12&time=12&satellites=12&%.16s&%.16s&%.10s&%.8s",buffer1,buffer2,buffer3,buffer4,buffer5,frame1);
